/*
 * Live2D Widget
 * https://github.com/17lai/live2d-widget
 */
...
function loadWidget(config) {
	...
	let userAction = false,
		userActionTimer,
		messageTimer,
		messageArray = ["好久不见，日子过得好快呢……", "大坏蛋！你都多久没理人家了呀，嘤嘤嘤～", "嗨～快来逗我玩吧！", "拿小拳拳锤你胸口！", "记得把小家加入 Adblock 白名单哦！主银不靠广告谋生，可以极大提高网页速度，并大大减少内存占用！"];
	...
	(function registerEventListener() {
		...
		document.querySelector("#waifu-tool .fa-paper-plane").addEventListener("click", () => {
			if (window.Asteroids) {
				...
				script.src = "https://cdn.jsdelivr.net/gh/17lai/asteroids@latest/asteroids.js";
		...
		document.querySelector("#waifu-tool .fa-info-circle").addEventListener("click", () => {
			open("https://github.com/17lai/live2d-widget");
		});
	...
	(function initModel() {
		...
		if (modelId === null) {
			...
			waifuDraggableRevert = false;	//松开鼠标还原拖拽位置，可选 true(真), false(假)
			homePageUrl = "https://blog.17lai.site";
		}
